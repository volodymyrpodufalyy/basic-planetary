...
Planet::Planet() {}
Planet::Planet(string name,double massInKg, double orbitalVelocity, double meanTemperature, int lengthOfDay,double distanceFromSun,type Ptype) : name(name),mass_in_kg(massInKg), orbital_velocity(orbitalVelocity),mean_temperature(meanTemperature), length_of_day(lengthOfDay),distance_from_sun(distanceFromSun),Ptype(Ptype) {}
Planet::~Planet() {}
